...
export default withRouter(
    class ToDoListPage extends React.Component {
      ...
      async componentDidMount() {
        ...
        // !!! Url is deprecated dans 'this.props.url.query.id' !!!
        // ref : https://github.com/vercel/next.js/blob/deprecated-main/errors/url-deprecated.md
        // query.equalTo("objectId",this.props.url.query.id);
        // const { router } = this.props
        // console.log(router)
        query.equalTo("objectId",this.props.query.id);
        try{
