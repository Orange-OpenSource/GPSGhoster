...
public abstract class ParseLoginDispatchActivity extends Activity {
  ...
  private void runDispatch() {
    ...
    if (currentUser != null) {
      // Ref : https://stackoverflow.com/questions/34807331/check-in-code-if-email-in-parseuser-was-verified-or-not
      if (currentUser.getBoolean("emailVerified") == true) {
        ...
        // close user serssion
        ParseUser.logOut();
        Toast.makeText(this, getString(R.string.com_parse_ui_parse_email_not_verified_toast), Toast.LENGTH_SHORT).show();
        debugLog(getString(R.string.com_parse_ui_login_dispatch_user_email_not_verified));
